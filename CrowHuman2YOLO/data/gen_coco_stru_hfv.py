# python gen_coco_stru_hfv.py --data_path /root/autodl-tmp/crowdedHuman/
...
parser.add_argument('--data_path', default='/root/autodl-tmp/crowdedHuman/',type=str)
...
# 数据集生成目录
to_train_img_path = data_path + 'images/train/' 
to_val_img_path = data_path + '/images/val/'
to_train_label_path = data_path + '/labels/train/'
to_val_label_path = data_path + '/labels/val/'
